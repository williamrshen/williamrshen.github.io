  ...
  return (
    <div className='navbar'>
      <ul className="nav-menu">
        <li>
          <a className='anchor-link' href='#home'><p><FiHome /></p></a> 
          {menu==="home" && <img src={new_underline} alt="" />}
        </li>
        <li>
          <a className='anchor-link' href='#about'><p><PiDetective /></p></a> 
          {menu==="about" && <img src={new_underline} alt="" />}
        </li>
        <li>
          <a className='anchor-link' href='#portfolio'><p><FaRegFolderOpen /></p></a> 
          {menu==="portfolio" && <img src={new_underline} alt="" />}
        </li>
        <li>
          <a className='anchor-link' href='#contact'><p><MdAlternateEmail /></p></a> 
